...
import { getAllBazaarPriceData, getItemNamesAndIDs } from '../servapi/HypixelAPI'
...
export async function prepareBazaarDataForRedis(): Promise<RedisBazaarHash> {
    ...
    bazaarEntries.forEach(([productkey, productval]) => {
        ...
        redisRet[productkey] = JSON.stringify({ sellPrice: productval.quick_status.sellPrice, buyPrice: productval.quick_status.buyPrice })
    })
    return redisRet
